...
public class Administrador implements Serializable {
    ...
    // Main constructor
    public Administrador(int clienteId, String curp, String rfc, String nombre, String apellidop, String apellidom,
                   String correo, String contrasenia, String extension, String tel, Direccion dir) {
        setAdminId(clienteId);
        setCurp(curp);
        setRfc(rfc);
        setNombre(nombre);
    ...
    public Administrador(String curp, String rfc, String nombre, String apellidop, String apellidom, String correo,
    ...
    public String toString() {
        return String.format("ID: %d\nCURP: %s\nRFC: %s\nNombre: %s\nApellido Paterno: %s\nApellido Materno: %s\n" +
                        "Correo: %s\nTelefono: (%s) %s\n\n== Direccion ==\n%s", adminID, curp, rfc, nombre, apellidop, apellidom,
